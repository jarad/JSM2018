...
\item Will Landau, Jarad Niemi, and Dan Nettleton. ``Fully Bayesian analysis of RNA-seq counts for the detection of gene expression heterosis.'' \emph{in press Journal of the American Statistical Association}.
\end{itemize}
}
